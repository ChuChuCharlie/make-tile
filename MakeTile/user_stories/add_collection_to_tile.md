...
### MakeTile actions
Any objects in the doorway_collection with boolean_type 'DIFFERENCE' are added as booleans to any objects with geometry type "CORE" and optionally if the "affects_base" flag is set to the base.

Any objects in the doorway_collection with boolean_type 'UNION' are added to the tile_collection collection. This means that they will be included on export.
